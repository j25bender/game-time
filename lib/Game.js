...
module.exports = class Game {
  ...
  gameLoop() {
    ...
    let brickDidBreak = this.brickArray.breakBricks(
      this.brickArray.brickField, this.ball);
  ...
  handleMouseEvent(event) {
  	if (!this.ball.hasBeenLaunched) {
  		this.followBall();  	
  	}
  	this.paddle.paddleMove(event, this.canvas);
  }

  launchBall() {
    this.ball.launch();
    this.ball.hasBeenLaunched = true;
  }
  ...
  thirdLevel() {
    ...
    this.brickArray = new BrickArray(4, 5);
  }
